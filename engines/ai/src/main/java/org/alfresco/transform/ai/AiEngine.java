...
public class AiEngine implements TransformEngine {

    private static final String ENGINE_NAME = "ai";
    private static final String CONFIG_PATH = "classpath:ai_engine_config.json";
