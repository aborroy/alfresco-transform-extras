...
public class OcrEngine implements TransformEngine {

    private static final String ENGINE_NAME = "ocr";
    private static final String CONFIG_PATH = "classpath:ocr_engine_config.json";
    ...
    public ProbeTransform getProbeTransform() {
        // NOTE: engines/ocr/src/main/resources/sample.pdf must be a real PDF binary
