...
public class PiiEngine implements TransformEngine {

    private static final String ENGINE_NAME = "pdf-pii";
    private static final String CONFIG_PATH = "classpath:pii_engine_config.json";
    ...
    public ProbeTransform getProbeTransform() {
        // NOTE: engines/pii/src/main/resources/sample.pdf must be a real PDF binary
